...
const FeaturedDestinations = () => {
  ...
  const destinations = [
    {
      id: 1,
      name: "Bhurj Khalifa, UAE",
      image:
        "https://images.unsplash.com/photo-1708800843969-64c90edb2d5f?w=800&h=600&fit=crop",
      price: "$1,299",
      duration: "7 Days",
      rating: 4.9,
      description: "Stunning skyline views from Burj Khalifa.",
      link: "/bhurj-khalifa",
    },
    {
      id: 2,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover amazing places around the world with our handpicked
